...
#balls.append(Ball([178,367,0],[0,0,0],'green',mainField.create_oval(0,0,0,0)))
##TEST
...
def calcBallDirection(dirX,dirY):
	...
	#print('dirBallX=',dirBallX,'dirBallY=',dirBallY)
...
def ballIsNotHitted(ballNumber,ballToCheckNumber):
	...
	flag=True
	#print(listOfCheckedBalls)
	for value in listOfCheckedBalls:
		#print(listOfCheckedBalls)
		#print('value[0]=',value[0],'value[1]=',value[1],'ballNumber=',ballNumber,'ballToCheckNumber=',ballToCheckNumber)
	...
	for ballToCheck in balls:
		if ball!=ballToCheck:
			...
			if distance<10 and ballIsNotHitted(ballNumber,ballToCheckNumber):
				...
				bTCX=ballToCheck.getCoords()[0]
				bTCY=ballToCheck.getCoords()[1]
				xTmp=x
				yTmp=y
				while True:
					xTmp=xTmp-dirX/10
...
#		yNew=(t/100)*dirY*pulse
	xNew=(t/100)*dirX*pulse
	yNew=(t/100)*dirY*pulse
	x=ball.getCoords()[0]+xNew/10
	y=ball.getCoords()[1]+yNew/10
